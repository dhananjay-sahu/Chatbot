...
import os
os.environ["GOOGLE_APPLICATION_CREDENTIALS"] = "C:/Users/SDO/Documents/UTD Padhai/NLP/Untitled Folder 1/chatbot-239603-eaccf5b214db.json"
...
def listen_print_loop(responses, text):
    ...
    for response in responses:
        ...
        if not result.is_final:
            ...
            #detect_intent_texts("resturant-locator", "123", user_input, "us-EN")
            num_chars_printed = 0           
